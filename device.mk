...
# Lights
PRODUCT_PACKAGES += android.hardware.light-service.xiaomi
...
# QTI fwk-detect
PRODUCT_PACKAGES += libvndfwk_detect_jni.qti.vendor # Needed by CNE app
...
# Seccomp policy
PRODUCT_COPY_FILES += $(LOCAL_PATH)/seccomp/mediacodec-seccomp.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy
